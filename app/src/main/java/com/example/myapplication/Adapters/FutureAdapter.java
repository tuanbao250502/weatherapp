...
public class FutureAdapter extends RecyclerView.Adapter<FutureAdapter.viewHolder> {
    ...
    public void onBindViewHolder(@NonNull FutureAdapter.viewHolder holder, int position) {
        ...
        int drawablerourceId =holder.itemView.getResources().getIdentifier(items.get(position).getPicPath(),"drawable",holder.itemView.getContext().getOpPackageName());
        Glide.with(context).load(drawablerourceId).into(holder.pic);
    }
